...
CFLAGS = -O -g -Wall -Wpointer-arith -Wstrict-prototypes -Wmissing-prototypes -Wmissing-declarations -Wnested-externs-Wall

ACLOCAL_M4 = $(top_srcdir)/aclocal.m4
mkinstalldirs = $(SHELL) $(top_srcdir)/mkinstalldirs
CONFIG_HEADER = config.h
CONFIG_CLEAN_FILES =  date-sh nickle.1 builtin.5c
...
pretty.o rational.o ref.o refer.o sched.o scope.o stack.o string.o \
struct.o symbol.o sync.o type.o util.o value.o gram.o lex.o
nickle_LDADD = $(LDADD)
nickle_DEPENDENCIES = 
nickle_LDFLAGS = 
...
Makefile.am Makefile.in NEWS TODO aclocal.m4 builtin.5c.in config.h.in \
configure configure.in date-sh.in gram.c install-sh lex.c missing \
mkinstalldirs nickle.1.in
...
.deps/divide.P .deps/edit.P .deps/error.P .deps/execute.P .deps/expr.P \
.deps/file.P .deps/float.P .deps/frame.P .deps/func.P .deps/gcd.P \
.deps/gram.P .deps/history.P .deps/int.P .deps/integer.P .deps/io.P \
.deps/lex.P .deps/main.P .deps/mem.P .deps/natural.P .deps/pretty.P \
.deps/rational.P .deps/ref.P .deps/refer.P .deps/sched.P .deps/scope.P \
.deps/stack.P .deps/string.P .deps/struct.P .deps/symbol.P .deps/sync.P \
.deps/type.P .deps/util.P .deps/value.P
...
nickle.1: $(top_builddir)/config.status nickle.1.in
	cd $(top_builddir) && CONFIG_FILES=$@ CONFIG_HEADERS= $(SHELL) ./config.status
builtin.5c: $(top_builddir)/config.status builtin.5c.in
	cd $(top_builddir) && CONFIG_FILES=$@ CONFIG_HEADERS= $(SHELL) ./config.status
...
uninstall-man uninstall-dataDATA install-dataDATA tags mostlyclean-tags \
